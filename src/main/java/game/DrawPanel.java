 ...
 */
public class DrawPanel extends JPanel implements BoardView {
    ...
    public void loadTextures() {
        ...
        try {
            ...
            File f =new File("src"+File.separator+"game"+File.separator+"textures"+File.separator+"grass.jpg");
            grassTexture = ImageIO.read(f);
            sandTexture = ImageIO.read(new File("out"+File.separator+"game"+File.separator+"textures"+File.separator+"sand.jpg"));
            waterTexture = ImageIO.read(new File("out/game/textures/water.jpg"));
            holeTexture = ImageIO.read(new File("out/game/textures/hole.jpg"));
            objectTexture = ImageIO.read(new File("out/game/textures/object.jpg"));
            ballTexture = ImageIO.read(new File("out/game/textures/ball.jpg"));
        } catch (IOException e) {
